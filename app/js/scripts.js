...
function searchAnitmationInput() {
	...
	const searchInput = document.querySelector('.search_form__input');
...
function arrowAnitmation() {
	const slideLinks = document.querySelectorAll('.promo_text_slide a');
	const arrow = document.querySelector('.promo_text_arrow');
...
$('.promo_port__btn').click(function(event) {
	const heightWindow = document.querySelector('.promo_port').clientHeight;
	event.preventDefault();
